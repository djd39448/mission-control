// Projects tab page - placeholder for future projects view
// TODO: Implement projects, task groupings, and outcomes
      ...
      <main className="flex min-h-screen flex-1 flex-col bg-gradient-to-b from-neutral-950 to-neutral-950/95 px-4 py-4 sm:px-8 sm:py-6">
        <div className="mb-4">
          ...
          <p className="text-xs text-neutral-500 sm:text-sm">
            Coming soon: Higher-level groupings of tasks and outcomes.
          </p>
        </div>

        <div className="rounded-lg border border-dashed border-neutral-800 bg-black/40 p-8 text-center text-neutral-500">
          <p className="text-sm">Projects view coming in a future checkpoint.</p>
        </div>
      </main>
    </div>
  );
